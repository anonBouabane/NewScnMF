...
class RegisterAssets extends StatefulWidget {
  const RegisterAssets({super.key});

  @override
  State<RegisterAssets> createState() => _RegisterAssetsState();
}

class _RegisterAssetsState extends State<RegisterAssets> {
  @override
